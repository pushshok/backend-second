...
public class ExampleTest extends AbstractTest {
    ...
    private static String urlToServer;


    @BeforeAll
    static void afterAll() {
//        System.out.println("Лог:");
//        logger.debug("DEBUG - " + urlToServer);
    ...
    void getExampleTest() {
        urlToServer = given()
                ...
                .then()
                .statusCode(200).extract().statusLine();
...
//                .statusCode(200);
    ...
    void getResponseData(){
        ...
        System.out.println("CookieName: " + response.getCookie("username"));
